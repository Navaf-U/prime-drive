    ...
    return (
        <div className="bg-gray-100 flex items-center justify-center min-h-screen">
            <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-sm">
                <h1 className="text-2xl font-semibold text-center text-purple-800 mb-6">Login</h1>
                <form>
                    <input
                        type="text"
                    ...
                    <p className="text-center mt-4">
                        Don&apos;t have an account? <a href="#" className="text-purple-800 hover:underline">Sign up</a>
                    </p>
                </form>
            </div>
        </div>
