    ...
    <div className="group">
      <div className="relative m-5 max-w-xs flex flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md transition-all duration-500 ease-in-out group-hover:shadow-xl group-hover:shadow-gray-500">
        ...
        <NavLink to="" className="relative mx-3 mt-3 flex justify-center">
          <p className="text-lg font-bold pt-2 text-slate-900 truncate">{name}</p>
        </NavLink>

        <div className="mt-4 px-5 pb-5 flex flex-col">
          <p className="text-gray-600">Model: <span className="font-semibold">{model}</span></p>
          <p className="text-gray-600">Company: <span className="font-semibold">{company}</span></p>
          <div className="mt-2 mb-5">
            ...
            <p className="flex items-center">
              <span className="text-lg font-bold text-slate-900">{years_old} years old</span>
            </p>
          </div>
          <p className="text-gray-600 mb-2">Description: <span className="font-semibold">{description}</span></p>
          <p className="text-gray-600 mb-2">Previous Owners: <span className="font-semibold">{previous_owners}</span></p>
          <NavLink
            to=""
